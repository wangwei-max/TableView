...
- (UIImageView *)arrowImage
{
    if (!_arrowImage) {
        ...
        arrowImage.animationImages = [NSArray arrayWithObjects:
                                         ...
                                         [UIImage imageNamed:@"load6.png"],nil];
        [arrowImage setAnimationDuration:2.0f];
        
        arrowImage.frame = CGRectMake(0, 0, self.width, self.height * 0.5);
...
- (instancetype)initWithFrame:(CGRect)frame {
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        self.backgroundColor = [UIColor clearColor];//COLOR(247,189,59, 1)
